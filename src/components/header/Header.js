      ...
      <div className="pos-f-t">
        ...
        <nav className="navbar navbar-light bg-faded navbar-fixed-top">
          <div className="container">
            <button type="button" className="float-xs-left hidden-md-up" data-toggle="collapse" data-target="#collapsingNavbar">&#9776;</button>

            <div id="collapsingNavbar" className="navbar-toggleable">
